...
def generate_osm(input_path: pathlib.Path,
  ...
  for img_path in pbar:
    ...
    seg_image = segment_img(image, latlon, zoom)
...
def segment_img(image: np.ndarray, latlon: tuple, zoom: int):
  ...
  img_buildings = passion.util.osm.get_footprints_latlon(bbox)
